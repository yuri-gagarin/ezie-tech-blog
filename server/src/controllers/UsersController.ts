...
export default class UsersController extends BasicController implements ICRUDController {
  async index(req: Request, res: Response<UsersIndexRes>): Promise<Response<UsersIndexRes>> {
    try {
  ...
  async getOne(req: Request, res: Response<UsersGetOneRes>): Promise<Response<UsersGetOneRes>> {
  ...
  async create(req: Request, res: Response<UsersCreateRes>): Promise<Response> {
  ...
  async edit(req: Request, res: Response<UsersEditRes>): Promise<Response> {
    const { user_id } = req.params;
  ...
  async delete(req: Request, res: Response<UsersDeleteRes>): Promise<Response> {
    const { user_id } = req.params;
